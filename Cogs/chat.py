...
class Chat(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.botID = environ['BOT'] # NSFW Annabelle Lee = 106996, Laurel Sweet = 71367 Lil Neko = 148149 SFW Cyber Ty = 63906, prob = 23958, 
            ...
            if set(database.get_config('chat', message.guild.id)) & set([role.id for role in message.author.roles]) or database.get_config('chat', message.guild.id) == [0]:
                ...
                async with ctx.typing():
                    ...
                    if emotion == 'happy-9':
                        ...
                        message_data = message_data + ' <:hehehe:968277440428400670>'
